...
public class AnimationPAnel : MonoBehaviour
{
    ...
    public RectTransform panel; // Ссылка на RectTransform панели
    public float duration = 1.0f; // Продолжительность анимации
    public float delay = 1.0f; // Задержка перед обратной анимацией
    ...
    void Start()
    {
        // Сохраняем начальные значения offsetMin и offsetMax
